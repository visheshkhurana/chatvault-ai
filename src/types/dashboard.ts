...
export type TabType = 'home' | 'search' | 'chats' | 'attachments' | 'summaries' | 'contacts' | 'commitments' | 'analytics' | 'settings' | 'assistant' | 'sentiment' | 'templates' | 'reminders' | 'labels' | 'reports';
