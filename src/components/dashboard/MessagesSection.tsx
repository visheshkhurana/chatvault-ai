...
export default function MessagesSection() {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="flex items-center gap-1 px-6 pt-6 pb-4 border-b border-gray-100">
        {tabs.map(t => (
          <button
            key={t.key}
            ...
            <div className={'border-r border-gray-100 overflow-y-auto '
              ...
              {loading ? (
                ...
                <div className="p-8 text-center">
                  ...
                  <p className="text-gray-400 text-xs mt-1">Connect WhatsApp to see your chats</p>
                </div>
              ) : (
                chats.map(chat => (
                  <button
            ...
            {selectedChat ? (
              <div className="flex-1 flex flex-col">
                <div className="px-4 py-3 border-b border-gray-100 flex items-center gap-3">
                  <button onClick={() => setSelectedChat(null)} className="md:hidden p-1 hover:bg-gray-100 rounded">
                    ...
                    messages.map(msg => (
                      <div key={msg.id} className="max-w-[80%]">
                        <div className="bg-gray-50 rounded-lg px-3 py-2">
                          <p className="text-xs font-medium text-emerald-600 mb-1">{formatPhone(msg.sender)}</p>
            ...
            {filteredAttachments.length === 0 ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 p-6">
                {filteredAttachments.map(att => {
                  ...
                  return (
                    <div key={att.id} className="border border-gray-100 rounded-lg p-3 hover:shadow-sm transition-shadow group">
              ...
              {searchResults.length === 0 ? (
                ...
                <div className="space-y-2 pb-6">
                  {searchResults.map(msg => (
                    <div key={msg.id} className="border border-gray-100 rounded-lg p-3 hover:bg-gray-50 transition-colors">
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-medium text-emerald-600">{formatPhone(msg.sender)}</span>
