    ...
    <div className="p-4 space-y-4 overflow-y-auto h-full">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">AI-powered relationship health scores</p>
        </div>
        <button
          onClick={recalculate}
      ...
      {scores.length === 0 ? (
        ...
        <div className="grid gap-3">
          {scores.slice(0, 20).map((score) => (
            ...
            >
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center text-purple-600 font-semibold text-sm">
      ...
      {scores.length > 0 && (
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
          <div className="bg-green-50 rounded-lg p-3 text-center">
            ...
            <p className="text-xs text-green-700">Strong</p>
          </div>
