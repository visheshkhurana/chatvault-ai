...
const ALLOWED_ORIGINS = (process.env.ALLOWED_ORIGINS || 'https://rememora.xyz,https://rememora.app,https://chatvault-ai.vercel.app,http://localhost:3000').split(',').map(s => s.trim());
