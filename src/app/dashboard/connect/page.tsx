...
export default function ConnectPage() {
  ...
  useEffect(() => {
        ...
        const interval = setInterval(() => {
                checkStatus();
                setQrKey(k => k + 1); // refresh QR image
        }, 15000);
        ...
        return (
                <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
                        <div className="bg-white rounded-2xl shadow-lg p-10 text-center max-w-md">
                                  ...
                                  <h1 className="text-2xl font-bold text-gray-900 mb-2">WhatsApp Connected!</h1>h1>
                                  <p className="text-gray-600 mb-6">Your WhatsApp is linked. Messages will be synced automatically.</p>p>
                                  <button
    ...
    return (
          <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-8">
                <div className="bg-white rounded-2xl shadow-lg p-10 text-center max-w-lg">
                        <h1 className="text-2xl font-bold text-gray-900 mb-2">Connect WhatsApp</h1>h1>
                  ...
                  {status === 'loading' ? (
                      ...
                      <div className="relative mx-auto" style={{ width: 280, height: 280 }}>
                        ...
                        <p className="text-sm text-gray-400 mt-4">QR refreshes automatically every 15 seconds</p>p>
                </div>div>
          </div>div>
        );
}</div>
