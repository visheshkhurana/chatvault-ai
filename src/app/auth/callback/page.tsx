...
export default function AuthCallbackPage() {
  ...
  useEffect(() => {
          const handleCallback = async () => {
                    try {
                                // Check for hash fragment (implicit flow) or code param (PKCE flow)
                      ...
                      if (code) {
                                  ...
                                  // Just calling getSession triggers the client to pick up the tokens
  ...
  return (
          <div className="min-h-screen flex items-center justify-center bg-surface-50">
                <div className="text-center">
                        ...
                        <p className="text-surface-600">Signing you in...</p>p>
                </div>div>
          </div>div>
        );
}</div>
